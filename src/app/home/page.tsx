      ...
      <div className="px-6 mt-6 space-y-6">
        ...
        {isUsersLoading ? (
          ...
          <div className="flex flex-col items-center justify-center h-full text-center py-20 px-10">
            <div className="w-24 h-24 bg-white/5 rounded-[2rem] flex items-center justify-center mb-6 border border-white/5 shadow-2xl">
              <RefreshCw className="w-10 h-10 text-muted-foreground/20" />
            </div>
            <h2 className="text-xl font-black text-white tracking-tighter mb-2 uppercase italic">No users yet</h2>
