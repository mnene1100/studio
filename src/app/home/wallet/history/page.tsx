      ...
      <div className="flex-1 px-6 py-8 bg-background">
        {isLoading ? (
          <div className="space-y-4">
            {[1, 2, 3].map(i => (
              <div key={i} className="h-24 bg-card rounded-[2rem] animate-pulse" />
            ))}
          </div>
          ...
          <div className="flex flex-col items-center justify-center h-[60vh] text-center">
            ...
            <h2 className="text-sm font-black text-muted-foreground uppercase tracking-widest italic">No transactions found</h2>
          </div>
        )}
      </div>
    </div>
